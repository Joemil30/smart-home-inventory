...
SUITES="verify aisle-test sheet-test home-test catalog-test backup-test ai-test cat-test import-test sw-test theme-test update-test history-test insights-test map-test"
fail=0
